...
#  Extended data not addressed: DPCount, IsDeployedOrReferenced, ContentTotal, ContentSupserseded, ContentExpired
...
$MyPackages = @(Get-CMApplication | Where { $_.IsLatest -eq $true}) # | Select Manufacturer, LocalizedDisplayName, SoftwareVersion, HasContent, IsDeployed, IsEnabled, IsLatest, IsSuperseded, SDMPackageXML
...
$MyPackages | Add-Member -MemberType NoteProperty -Name ContentSupserseded -Value 0
...
#$MyPackages | Select Type, PackageID, MBTotal, Name, ContentTotal, ContentSupserseded, ContentExpired, IsDeployedOrReferenced, DPCount, PkgSourcePath | Format-Table -AutoSize
$CombinedPackages += $MyPackages | Select Type, PackageID, MBTotal, Name, ContentTotal, ContentSupserseded, ContentExpired, IsDeployedOrReferenced, DPCount, PkgSourcePath
...
ForEach ($MyPackage in ($MyPackages | Where { $_.HasContent -eq $true})) {
    ForEach ($DeploymentType in (([xml]($MyPackage.SDMPackageXML)).AppMgmtDigest.DeploymentType)) {
        ...
        $ThisPackage | Add-Member -MemberType NoteProperty -Name ContentSupserseded -Value $null
        ...
        #$ThisPackage | Select PackageID, Name, PackageSize, LastRefreshTime, PkgSourcePath, Type, MBTotal, ContentTotal, ContentSupserseded, ContentExpired, IsDeployedOrReferenced, DPCount
        $CombinedPackages += $ThisPackage | Select PackageID, Name, PackageSize, LastRefreshTime, PkgSourcePath, Type, MBTotal, ContentTotal, ContentSupserseded, ContentExpired, IsDeployedOrReferenced, DPCount
    }
}


#Get standard Software Packages
$MyPackages = @(Get-CMPackage | Select PackageID, Name, PackageSize, LastRefreshTime, Manufacturer, Version, PkgSourcePath)
...
$MyPackages = @(Get-CMSoftwareUpdateDeploymentPackage | Select PackageID, Name, PackageSize, LastRefreshTime, PkgSourcePath)
$MyPackages | Add-Member -MemberType NoteProperty -Name Type -Value 'Software Updates'
$MyPackages | Add-Member -MemberType NoteProperty -Name MBTotal -Value $null
$MyPackages | Add-Member -MemberType NoteProperty -Name DPCount -Value $null
$MyPackages | Add-Member -MemberType NoteProperty -Name IsDeployedOrReferenced -Value $null
$MyPackages | Add-Member -MemberType NoteProperty -Name ContentTotal -Value $null
$MyPackages | Add-Member -MemberType NoteProperty -Name ContentSupserseded -Value $null
$MyPackages | Add-Member -MemberType NoteProperty -Name ContentExpired -Value $null
$MyPackages | ForEach { $_.MBTotal = [math]::Round($_.PackageSize/1024,1) }
$CombinedPackages += $MyPackages
...
#Get Driver Packages
$MyPackages = @(Get-CMDriverPackage | Select PackageID, Name, PackageSize, LastRefreshTime, PkgSourcePath)
...
$MyPackages = @(Get-CMOperatingSystemImage | Select PackageID, Name, PackageSize, LastRefreshTime, PkgSourcePath)
...
$MyPackages = @(Get-CMOperatingSystemInstaller | Select PackageID, Name, PackageSize, LastRefreshTime, PkgSourcePath)
...
$MyPackages = @(Get-CMBootImage | Select PackageID, Name, PackageSize, LastRefreshTime, PkgSourcePath)
...
$MyPackages = @(Get-CMvhd | Select PackageID, Name, PackageSize, LastRefreshTime, PkgSourcePath)
...
#$CombinedPackages += $MyPackages | Select PackageID, Name, PackageSize, LastRefreshTime, PkgSourcePath, Type, MBTotal, ContentTotal, ContentSupserseded, ContentExpired, IsDeployedOrReferenced, DPCount

$CombinedPackages | Select Type, PackageID, MBTotal, Name, LastRefreshTime, ContentTotal, ContentSupserseded, ContentExpired, IsDeployedOrReferenced, DPCount, PkgSourcePath | Export-CSV -Path $ReportFile -NoTypeInformation
$CombinedPackages | Sort-Object PackageSize | Select Type, PackageID, MBTotal, Name, LastRefreshTime, ContentTotal, ContentSupserseded, ContentExpired, IsDeployedOrReferenced, DPCount, PkgSourcePath | Format-Table -AutoSize
