...
' DATE  : 8/7/2010
'
' Updated 2014/11/06 by Chad.Simmons@CatapultSystems.com
'   - corrected syntax error in last line
'   - added exit/return codes to wscript.quit calls
'
...
If arrArguments.Count <> 3 Then
	...
	WScript.Echo "Note: %_SMSTSClientIdentity% is the 41 character ConfigMgr Unique ID in the format 'GUID:xxxxxxx'"
	WScript.Echo "see http://blogs.msdn.com/b/vinpa/archive/2010/09/01/how-to-add-a-known-unknown-computer-to-a-specified-collection-during-os-deployment.aspx"
...
If strResourceID = 0 Then
	...
	WScript.Quit 1169 'ERROR_NO_MATCH
End If
...
If oCollection.Name = "" Then
	...
	WScript.Quit 1168 'ERROR_NOT_FOUND
End If
