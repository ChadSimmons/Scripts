<#
.SYNOPSIS
    New-SSRS_EmailSubscription_Compliance_1_-_Overall compliance.ps1
...
If ($psISE) {
    ...
    [string]$AdvertisementID = 'E:\Scripts\New-SSRS_EmailSubscription_Compliance_1_-_Overall compliance.ps1.xml'
...
ForEach ($AdvertID in $AdvertisementID.Split(',')) {
    ...
    ------------------------------
    CollID DAL00084
    AuthListID ScopeId_D955DB0D-84DB-4C03-B5F6-6E4C056B0BED/AuthList_359b0ea4-58e6-4b5e-a431-36addca02181
    #>
    ...
    [string]$ReportName='Compliance 1 - Overall compliance'
    [string]$ReportPath="/$ReportPathRoot/Software Updates - A Compliance"
    [string]$SubscriptionDescription = "Software Update Group Compliance - $($Deployment.SoftwareName) - " + $($Deployment.CollectionID)
    [string]$SubscriptionComment     = "This report will run from $StartTime to $EndTime`r`nSoftware Update Group: $($Deployment.SoftwareName)`r`nCollection: $($Deployment.CollectionName) ($($Deployment.CollectionID))"
    ...
    "<Subscription>
	    ...
	    <ReportParameter>
		    <ParameterValue>
			    <Name>CollID</Name>
			    <Value>$($Deployment.CollectionID)</Value>
		    </ParameterValue>
		    <ParameterValue>
			    <Name>AuthListID</Name>
			    <Value>$($Deployment.ModelName)</Value>
		    </ParameterValue>
	    </ReportParameter>
    </Subscription>"
