@echo off
setlocal
set AppTitle=Windows 10 v1809 Cumulative .NET Update
set SetupFile1=windows10.0-kb4506990-x64_b08d8cae796e003093469d9ff4559b7464086617.msu
set SetupFile2=windows10.0-kb4506998-x64_fc6c6f2e21cfddd6305b9ab19026a6789e666eac.msu
...
start /wait "Installing %AppTitle%..." wusa.exe "%SourceDir%\%SetupFile1%" %SetupOPT%
...
If %ReturnCode%==0 OR %ReturnCode%==3010 (
	start /wait "Installing %AppTitle%..." wusa.exe "%SourceDir%\%SetupFile2%" %SetupOPT%
	set ReturnCode=%errorlevel%
	If %ReturnCode%==1707 set ReturnCode=3010
	If %ReturnCode%==2359301 set ReturnCode=3010
	If %ReturnCode%==2359302 set ReturnCode=0
